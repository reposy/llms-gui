...
export const FlowEditor = () => {
  ...
  }, [hydrated, nodes.length, edges.length]); // Depend on hydration and initial nodes/edges
  ...
  const handleAddNode = useCallback((type: NodeType) => {
    ...
    // Force sync from Zustand to React Flow UI
    // We let useFlowSync handle the update from Zustand change
  ...
  return (
    <div className="h-screen w-screen flex flex-col overflow-hidden">
      {/* StoreInitializer REMOVED - Initialization handled in App.tsx */}
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-none w-20 bg-white border-r border-gray-200 p-4 shadow-lg z-10 flex flex-col items-center space-y-4 overflow-y-auto">
           {/* LLM Node Button */}
           <button
              className="w-full aspect-square rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-md hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center gap-1 text-xs font-medium p-1"
            ...
            {/* API Node Button */}
            <button
              className="w-full aspect-square rounded-xl bg-gradient-to-br from-green-500 to-green-600 text-white shadow-md hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center gap-1 text-xs font-medium p-1"
            ...
            {/* Output Node Button */}
            <button
              className="w-full aspect-square rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-md hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center gap-1 text-xs font-medium p-1"
            ...
            {/* Input Node Button */}
            <button
              className="w-full aspect-square rounded-xl bg-gradient-to-br from-gray-500 to-gray-600 text-white shadow-md hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center gap-1 text-xs font-medium p-1"
            ...
            {/* Group Node Button */}
            <button
              className="w-full aspect-square rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 text-white shadow-md hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center gap-1 text-xs font-medium p-1"
            ...
            {/* Conditional Node Button */}
            <button
              className="w-full aspect-square rounded-xl bg-gradient-to-br from-yellow-500 to-yellow-600 text-white shadow-md hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center gap-1 text-xs font-medium p-1"
              onClick={() => handleAddNode('conditional')}
               title="Add Conditional Node"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            {/* Merger Node Button */}
            <button
              className="w-full aspect-square rounded-xl bg-gradient-to-br from-teal-500 to-teal-600 text-white shadow-md hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center gap-1 text-xs font-medium p-1"
              onClick={() => handleAddNode('merger')}
              title="Add Merger Node"
            >
               <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            {/* JSON Extractor Node Button */}
            <button
              className="w-full aspect-square rounded-xl bg-gradient-to-br from-pink-500 to-pink-600 text-white shadow-md hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center gap-1 text-xs font-medium p-1"
            ...
            {/* Web Crawler Node Button */}
            <button
              className="w-full aspect-square rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-600 text-white shadow-md hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center gap-1 text-xs font-medium p-1"
              onClick={() => handleAddNode('web-crawler' as NodeType)}
              title="Add Web Crawler Node"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="flex-1 relative">
          ...
          <ReactFlowProvider>
            <FlowCanvas 
              ...
              onNodeSelect={() => { /* Node selection handled via Zustand now */ }}
            />
          </ReactFlowProvider>
        </div>
